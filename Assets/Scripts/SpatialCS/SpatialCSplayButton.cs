...
public class PlayButtonController : MonoBehaviour
{
	...
	private void Start()
	{
		...
		{
			Debug.LogWarning("Parent to play button does not have SpatialCSplayerControls behavior");
			return;
		}
		...
		m_playing = m_controller.IsSpatialPlaying();
		SetMesh();
	}
	...
	private void Update()
	{
		...
		if(m_playing != m_controller.IsSpatialPlaying())
		{
			m_playing = m_controller.IsSpatialPlaying();
			SetMesh();
		}
